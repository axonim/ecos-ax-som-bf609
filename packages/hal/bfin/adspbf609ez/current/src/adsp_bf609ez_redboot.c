//*==========================================================================
//
//      adsp_bf609ez_redboot.c
//
//      Redboot support code for BlackFin adsp_bf609ez board
//
//==========================================================================
...
/* Kick the watchdog. */
// static void
// adsp_bf609ez_kick_watchdog(bool is_idle)
// {
...
// static void
// adsp_bf609ez_cmd_watchdog(int argc, char *argv[])
// {
    // cyg_uint32 reg_val;
...
// static void
// adsp_bf609ez_check_dipswitches(void)
// {
...
// RedBoot_init(adsp_bf609ez_check_dipswitches,  RedBoot_INIT_PRIO(500));
// #endif // ifdef CYGFUN_REDBOOT_BOOT_SCRIPT

#endif // ifdef CYGPKG_REDBOOT

//--------------------------------------------------------------------------
// EOF adsp_bf609ez_redboot.c
